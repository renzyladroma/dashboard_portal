...
$(document).ready(function(){
	...
	$.ajax({    //create an ajax request to load_page.php
        type: "GET",
        url: "<?php echo base_url(); ?>index.php/Ads_Report/get_report_location_graph_all",             
	...
	$.ajax({  //create an ajax request to load_page.php
        type: "GET",
        url: "<?php echo base_url(); ?>index.php/Ads_Report/get_report_location_table_all",             
        dataType: "html",   //expect html to be returned                
        success: function(outEvoVal) {    
		  console.log(outEvoVal);
	...
	$("#submit").click(function(){
		...
		$.ajax({    
				url: '<?php echo base_url(); ?>index.php/Ads_Report/get_report_location_graph',
				type: "POST",
				dataType: "html",
				data: datastring,
				success: function(outEvoVal) {
		...
		$.ajax({    
				url: '<?php echo base_url(); ?>index.php/Ads_Report/get_report_location_table',
				type: "POST",
				dataType: "html",
				data: datastring,
				success: function(outEvoVal) {
		...
		<div class="row">
		  <div class='col-sm-12 col-md-12 col-lg-12'>
			<div class='card card-block'>
				<h3>Total Impression/Click per Ads</h3>
